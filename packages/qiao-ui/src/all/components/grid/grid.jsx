...
export const Grid = (props) => {
  colorLog('qiao-ui/all/grid: render');
  ...
  // effect
  useEffect(() => {
    colorLog('qiao-ui/all/grid: useEffect');
    reload();
  }, []); // eslint-disable-line react-hooks/exhaustive-deps

  // reload
  const reload = async (data, pagenumber) => {
    colorLog('qiao-ui/all/grid: reload');
  ...
  // edit row
  const editRow = (row) => {
    colorLog('qiao-ui/all/grid: editRow');
  ...
  const delRow = async (id) => {
    colorLog('qiao-ui/all/grid: delRow');
  ...
  const checkboxChange = (e) => {
    colorLog('qiao-ui/all/grid: checkboxChange');
